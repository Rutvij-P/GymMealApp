...
extension Recipe {
    static let all: [Recipe] = [
        ...
        Recipe(name: "Raspberry Truffle Brownies",
               ...
               category: "Dessert",
               datePublished: "February 10, 2014",
        ...
        Recipe(name: "Kale Bruschetta",
               ...
               category: "Side",
               datePublished: "June 28, 2015",
               url: "https://www.forksoverknives.com/recipes/vegan-snacks-appetizers/kale-bruschetta/"),
        Recipe(name: "Jackfruit Barbecue Sandwiches with Broccoli Slaw",
               image: "https://www.forksoverknives.com/wp-content/uploads/fly-images/127574/jackfruit-sandwiches-flipped-360x270-c.jpg",
               description: "Jackfruit has a meaty texture that soaks up flavors from an easy homemade barbecue sauce to make this classic-style sandwich. Shredded broccoli and mashed avocado make for a creamy, crunchy slaw.\nNote: Canned jackfruit can be full of sodium. Check labels and select the brand with the lowest amount of sodium, or look for frozen jackfruit and thaw before using.",
               ingredients: "½ of a small avocado, seeded and peeled\n2 teaspoons lime juice\n3 cups shredded broccoli slaw mix\n¼ cup sliced scallions (green onions)\n1⅓ cups no-salt-added tomato sauce\n3 pitted whole dates\n1½ teaspoons chili powder\n2 cloves garlic\n½ teaspoon smoked paprika\n¼ teaspoon freshly ground black pepper\n1 14-oz. can green jackfruit, rinsed, drained, and chopped\n1 cup cooked farro\n6 whole wheat hamburger buns, toasted",
               directions: "For slaw, in a large bowl mash together avocado and lime juice. Add broccoli slaw mix and scallions; stir to combine. Cover and let stand while preparing filling.\nFor filling, in a blender combine the next six ingredients (through pepper). Cover and blend until smooth. Pour into a medium saucepan. Stir in jackfruit and farro. Cover and heat through over medium, stirring occasionally.\nSpoon jackfruit mixture into buns. Top with slaw.",
               category: "Side",
               datePublished: "August 10, 2020",
               url: "https://www.forksoverknives.com/recipes/vegan-burgers-wraps/jackfruit-barbecue-sandwiches-with-broccoli-slaw/")
    ]
}
